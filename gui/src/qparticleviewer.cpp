...
QParticleViewer::QParticleViewer( QWidget * parent, const char * name , Qt::WFlags f, GridSlamProcessorThread* thread): 
...
void QParticleViewer::paintEvent ( QPaintEvent *paintevent ){
  ...
  //QImage::bitBlt(this,0,0,m_pixmap,0,0,m_pixmap->width(),m_pixmap->height(), Qt::CopyROP);
	...
	painter_tmp.drawPixmap(0, 0, m_pixmap->width(), m_pixmap->height(), *m_pixmap);
}
...
void QParticleViewer::drawFromFile(){
  ...
  string line=is.readLine().toStdString();
